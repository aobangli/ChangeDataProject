...
def main():
    ...
    file_header = ["project", "change_id", 'created', 'subject'] + features_list + ['avg_score', 'status', 'time', 'rounds']
    ...
    for change_number in tqdm(change_numbers):
        ...
        label_features = calculator.label_features
...
class FeatureCalculator:
    ...
    def label_features(self):
        features, label_list = {}, self.change.labels
        score_sum = 0
