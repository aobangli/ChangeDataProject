...
features_group = {
    'author': ['author_experience', 'author_merge_ratio', 'author_changes_per_week',
               ...
               'author_change_duration_min', 'author_change_duration_max',
               'author_change_duration_avg', 'author_change_duration_std'],
    ...
    'project': ['project_changes_per_week', 'project_merge_ratio', 'changes_per_author',
                'project_author_num', 'project_duration_per_change', 'project_commits_per_change',
                'project_comments_per_change', 'project_file_num_per_change', 'project_churn_per_change',
    ...
    'code': ['lines_added', 'lines_updated', 'lines_deleted', 'files_added', 'files_deleted', 'files_modified',
             ...
             'language_num', 'file_type_num', 'segs_added', 'segs_deleted', 'segs_updated'],
